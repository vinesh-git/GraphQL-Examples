...
function AddUser() {
    ...
    const {mutate,error,isPending} = useMutation<CreateUserResponse,Error,{name : string,age:number,IsMarried : boolean}>({
  ...
  return (
    ...
    <button onClick={() => mutate({name,age,IsMarried : true})} >Add</button>
